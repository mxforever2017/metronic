...
define(function (require) {
        ...
        */
        ...
        $('body').on('click', '.sidebar-toggler', function (e) {
            ...
            if (body.hasClass("page-sidebar-closed")) {
                ...
                // }
                Cookies.setCookie('sidebar_closed','0');
            } else {
                body.addClass("page-sidebar-closed");
                ...
                // }
                Cookies.setCookie('sidebar_closed','1');
            }
    ...
    var handleUniform = function () {
        ...
        var test = $("input[type=checkbox]:not(.toggle, .make-switch), input[type=radio]:not(.toggle, .star)");
        if (test.size() > 0) {
            test.each(function () {
    ...
    var initSidebarMenu = function() {
        console.log('123');
        console.log(Cookies.getCookie('sidebar_closed'));
        if (Cookies.getCookie('sidebar_closed') === '1') {
            $('body').addClass("page-sidebar-closed");
            $('.page-sidebar-menu').addClass("page-sidebar-menu-closed");
        }
    }
